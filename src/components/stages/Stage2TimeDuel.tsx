        ...
        <div className="lg:col-span-2 bg-slate-900/90 border border-slate-800 rounded-3xl p-6 flex flex-col justify-between shadow-xl relative overflow-hidden">
          ...
          <div className="py-6 flex flex-col items-center text-center">
            ...
            <div className="flex items-center gap-3">
              {playbackStatus === 'idle' ? (
                <button
                  ...
                  className="px-8 py-3.5 rounded-2xl font-bold text-sm flex items-center gap-2.5 transition-all cursor-pointer shadow-lg bg-amber-500 hover:bg-amber-400 text-slate-950 shadow-amber-500/30 active:scale-95"
                >
                ...
                <>
                  <button
                    id="stage2-pause-music-btn"
                    onClick={handlePauseMusic}
                    className="px-6 py-3.5 rounded-2xl font-bold text-sm flex items-center gap-2 transition-all cursor-pointer shadow-lg bg-amber-500 hover:bg-amber-400 text-slate-950 shadow-amber-500/30 active:scale-95"
                  >
                    <Pause className="w-5 h-5 fill-current" />
                    <span>Pauza</span>
                  </button>
                  <button
                    id="stage2-stop-music-btn"
                    onClick={handleStopMusic}
                    className="px-5 py-3.5 rounded-2xl font-bold text-sm flex items-center gap-2 transition-all cursor-pointer bg-slate-800 hover:bg-rose-900/60 text-rose-300 border border-slate-700 hover:border-rose-500/40 active:scale-95"
                  >
                ...
                <>
                  <button
                    id="stage2-resume-music-btn"
                    onClick={handleResumeMusic}
                    className="px-7 py-3.5 rounded-2xl font-bold text-sm flex items-center gap-2 transition-all cursor-pointer shadow-lg bg-emerald-600 hover:bg-emerald-500 text-white shadow-emerald-600/30 active:scale-95"
                  >
                    <Play className="w-5 h-5 fill-current" />
                    <span>Davam Et (Pauzadan)</span>
                  </button>
                  <button
                    id="stage2-reset-music-btn"
                    onClick={handleStopMusic}
                    className="px-5 py-3.5 rounded-2xl font-bold text-sm flex items-center gap-2 transition-all cursor-pointer bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 active:scale-95"
                  >
            ...
            <p className="text-xs text-slate-400 mt-2">
              {playbackStatus === 'playing'
                ? 'Mahnı səslənir... Komandaların zəngini gözləyin.'
                : playbackStatus === 'paused'
                ? 'Mahnı fasilədədir. Davam etmək üçün "Davam Et" düyməsini sıxın.'
                : 'Mahnını ifa etmək üçün düyməyə basın'}
            </p>
          </div>
